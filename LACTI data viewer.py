...
def check_data(data_path):
  ...
  plt.figure()
  plt.imshow(np.mean(dcm['FloatProjectionData'], 2))
...
def browseFiles():
    filename = askdirectory(title='Select Folder') # shows dialog box and return the path
    check_data(filename)
    plt.show
...
img = ImageTk.PhotoImage(Image.open("PennMedicineLogo_50-removebg-preview.png"))
